...
Ruby (Sinatra) demo app for Deepgram Voice Agent.
...
```
feat(ruby-voice-agent): add diarization support
fix(ruby-voice-agent): resolve WebSocket close handling
refactor(ruby-voice-agent): simplify session endpoint
